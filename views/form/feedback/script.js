...
$(function () {
  ...
  // при нажатии на кнопку "Обновить", выводим новый код капчи
  $('#reload-captcha').click(function () {
    $('#img-captcha').attr('src', '/views/form/feedback/captcha.php?id=' + Math.random() + '');
  });
  ...
  $('#messageForm').submit(function (event) {
    ...
    //2. Если длина кода капчи, которой ввёл пользователь не равно 4,
    ...
    // форма валидна и длина капчи равно 4 символам, то отправляем форму на сервер (AJAX)
    if ((formValid) && (captcha.length == 4)) {
      ...
      $.ajax({
        ...
        type: "POST",
        //URL-адрес запроса 
        url: "/views/form/feedback/verify.php",
