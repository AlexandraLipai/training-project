        ...
        <div class="grid_12">
            <div class="box-shadow">
                <div class="wrap block-2">
                    ...
                    <div class="col-4">
                        <h2><span class="color-1">Authorization</span> </h2>
                        <?php
                        ...
                        <form id="form" method="post" action="#">
                            <fieldset>
                                <label><input type="text" name="email" placeholder="Email" value="<?=@$_POST['email']?>"></label>
                                <label><input type="password" name="password" placeholder="Password"></label>
                                <button type="submit" name="submit" class="search_button">Log In</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
